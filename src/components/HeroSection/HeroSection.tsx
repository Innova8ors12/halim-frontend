  ...
  return (
    ...
    >
      <div className="container py-20">
        <h1 className="text-5xl md:text-6xl font-bold text-black max-w-2xl">
          Driving Efficiency and Innovation in Industrial Engineering
        </h1>
        <p className="font-roboto text-lg md:text-xl text-black font-medium mt-8 max-w-md leading-6">
